...
The code is written so that the ESP8266 creates an access point. Once powered ON you can connect to this WiFi device with your phone or a local computer. Search for the "Fairy Controller" WiFi access point. Once connected open a Web page and type: 192.168.4.1 and the following page will come up: 
